...
namespace EduQuiz_5P.Services.Interface
{
    ...
    {
        public Task<ICollection<ExamMatrix>> GetListAsync(int? subjectId = null, Func<IQueryable<ExamMatrix>, IIncludableQueryable<ExamMatrix, object>>? includes = null, string? Name = null);
